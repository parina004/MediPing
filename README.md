...
My mom forgets her medicine. A lot. And the usual fixes like pill organizers, phone alarms just weren't working. So I built MediPing: a WhatsApp-based reminder system that works entirely through a chat she already uses every day. No app to download, no interface to learn. Just a message and a reply
